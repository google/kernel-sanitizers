...
static inline kt_stack_depot_obj_t *
kt_stack_depot_lookup(kt_stack_depot_obj_t *obj, kt_stack_t *stack, u32 hash)
{
...
static inline kt_stack_handle_t
kt_stack_depot_obj_to_handle(kt_stack_depot_t *depot, kt_stack_depot_obj_t *obj)
{
	return ((uptr_t)obj - depot->stack_cache.base) / sizeof(u32);
}

static inline kt_stack_depot_obj_t *
kt_stack_depot_handle_to_obj(kt_stack_depot_t *depot, kt_stack_handle_t handle)
{
				      ...
				      kt_stack_t *stack)
{
	...
	if (!obj) {
		obj = (kt_stack_depot_obj_t *)(depot->stack_cache.base +
					       depot->stack_offset);
		depot->stack_offset +=
			sizeof(*obj) + sizeof(stack->pc[0]) * stack->size;
