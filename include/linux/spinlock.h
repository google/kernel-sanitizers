 ...
 */
extern int atomic_dec_and_lock(atomic_t *atomic, spinlock_t *lock) __cond_acquires(1, lock);
...
extern int atomic_dec_and_raw_lock(atomic_t *atomic, raw_spinlock_t *lock) __cond_acquires(1, lock);
