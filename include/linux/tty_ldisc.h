...
int ldsem_down_read(struct ld_semaphore *sem, long timeout) __cond_acquires_shared(1, sem);
int ldsem_down_read_trylock(struct ld_semaphore *sem) __cond_acquires_shared(1, sem);
int ldsem_down_write(struct ld_semaphore *sem, long timeout) __cond_acquires(1, sem);
int ldsem_down_write_trylock(struct ld_semaphore *sem) __cond_acquires(1, sem);
...
int ldsem_down_read_nested(struct ld_semaphore *sem, int subclass,
		long timeout) __cond_acquires_shared(1, sem);
int ldsem_down_write_nested(struct ld_semaphore *sem, int subclass,
		long timeout) __cond_acquires(1, sem);
#else
